...
export default class Banner extends Component {
  ...
  render({ context, algorithm, whitelist, publisherNote, size }, { fetched, noData, currentAd, ads }) {
    if (!fetched) {
      return null;
    }
    ...
    return (
      <div class={cx(['this', size])}>
        ...
        <div class={style.options}>
          <Menu context={context} algorithm={algorithm} whitelist={whitelist} publisherNote={publisherNote} ads={ads} />
